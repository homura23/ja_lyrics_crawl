...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output-file', type=str, default="out2.pkl", help="输出路径")
    ...
    if args.ctn:
        if songs:
            start_id = songs[-1]["id"] + 1

    for i in range(start_id, start_id + args.max_song_num):
        lyric = get_lyric(i)
        if lyric is None:
            continue
